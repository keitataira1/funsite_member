...
public class PlayerServiceTest {
	...
	void testSelectLikeName_001_パーセント付与の確認() {
		...
		playerList.add(new PlayerEntity(1, "test1",null,"a","b","c","d", 1));
		playerList.add(new PlayerEntity(2, "test2",null,"a","b","c","d", 1));
		// モックの設定
		...
		expected.add(new PlayerEntity(1, "test1",null,"a","b","c","d", 1));
		expected.add(new PlayerEntity(2, "test2",null,"a","b","c","d", 1));
